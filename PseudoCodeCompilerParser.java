...
public class PseudoCodeCompilerParser extends Parser {
	...
	public final ForLoopContext forLoop() throws RecognitionException {
		...
		try {
			...
			condition();
			setState(74);
			((ForLoopContext)_localctx).SC = match(SC);
			checkSC((((ForLoopContext)_localctx).SC!=null?((ForLoopContext)_localctx).SC.getText():null),(((ForLoopContext)_localctx).SC!=null?((ForLoopContext)_localctx).SC.getLine():0));
			setState(76);
	...
	public final AtributionContext atribution() throws RecognitionException {
		...
		try {
			...
			setState(133);
			((AtributionContext)_localctx).SC = match(SC);
			checkSC((((AtributionContext)_localctx).SC!=null?((AtributionContext)_localctx).SC.getText():null),(((AtributionContext)_localctx).SC!=null?((AtributionContext)_localctx).SC.getLine():0));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DeclarationContext declaration() throws RecognitionException {
		...
		try {
			...
			setState(141);
			((DeclarationContext)_localctx).SC = match(SC);
			checkSC((((DeclarationContext)_localctx).SC!=null?((DeclarationContext)_localctx).SC.getText():null),(((DeclarationContext)_localctx).SC!=null?((DeclarationContext)_localctx).SC.getLine():0));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final WriteContext write() throws RecognitionException {
		...
		try {
			...
			match(T__4);
			setState(228);
			((WriteContext)_localctx).SC = match(SC);
			x.printData(")");checkSC((((WriteContext)_localctx).SC!=null?((WriteContext)_localctx).SC.getText():null),(((WriteContext)_localctx).SC!=null?((WriteContext)_localctx).SC.getLine():0));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
